		...
		<div id="body">
			<section id="define">
				...
				<div className="image-overlay">
					<h3 className="btn btn-light" onClick={handleHi}>
						Hola! 👋
					</h3>
					...
					<h6 className="d-flex justify-content-end mt-3 pt-3">
						P.S. Pick this buddy to see the world{' '}
						<BsFillArrowDownCircleFill
							style={{ color: 'green' }}
							className="ms-2 color-cyan fs-5"
						/>
					</h6>
				</div>
			</section>
